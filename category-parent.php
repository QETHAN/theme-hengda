 ...
 <div id="m-warp">
	<div class="s-middle">
    	<div class="s-left" id="conLeft">
        	<ul>
              <?php $categories = get_categories("child_of=3&orderby=ID"); ?>
        ...
        <div class="s-right" id="conRight">
            ...
            <span class="guide">
              <a href="<?php site_url(); ?>">Home</a> » <?php echo ucwords(strtolower(get_the_category()[0]->cat_name)); ?>
            </span>
            <h1><?php echo ucwords(strtolower(get_the_category()[0]->cat_name)); ?></h1>
          </div>
            <!--[if lte IE 10]>
            <style>
