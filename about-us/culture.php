...
<div id="m-warp">
  ...
  <div class="s-right" id="conRight">
        	<div class="rightTitle"><span class="guide"><a href="<?php echo home_url(); ?>">Home</a> » <a href="<?php echo get_category_link($cats[0]->cat_ID); ?>">About Us</a> » Hengda Culture </span><h1>Hengda Culture</h1></div>
          <div class="rightMain">
