<?php
/*
 * Template Name: Hengda Technology页面模板
...
<div id="m-warp">
    ...
    <div class="clear"></div>
        	...
        	<div class="rightTitle"><span class="guide"><a href="<?php echo home_url(); ?>">Home</a> » <a href="<?php echo get_category_link($cats[0]->cat_ID); ?>">About Us</a> » Hengda Technology </span><h1>Hengda Technology</h1></div>
          <div class="rightMain">
                <div class="about-info2">
                   <!-- 内容开始 -->
                    <div class="rightTop">Hengda, as the leading manufacturer of paper pulp equipment, with German quality management system and standard, we devote to build a world brand in paper and pulp industry.</div>
                    <div class="about-right"><img onload="size(this)" alt="Hengda Technology" src="<?php echo get_theme_file_uri(); ?>/images/about2_04.jpg"></div>
                    <p>HENGDA has a long history of innovation for the pulp and paper making industries. HENGDA’s focus on research and development work is currently aimed at cost-efficient, modularized and standardized solutions with the right technology scope. These solutions can efficiently improve raw material and energy efficiency and also lower customers' investment costs. </p>
                    <p>HENGDA is a leading pulp and paper manufacturer in China and has a great influence in Domestic and International Pulp &amp; Paper industry. By adopting high technology aboard and advanced paper processing technology, HENGDA provides high quality and reliable pulp and paper making equipments for the customers. </p>
...
<form method="post" action="http://www.zzhengdachina.com/mail/leizhan/" onsubmit="return chkInquiry()" name="msgForm" target="msgFrame">
