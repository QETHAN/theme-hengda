<?php
/*
 * Template Name: Product Market页面模板
...
<div id="m-warp">
    ...
    <div class="clear"></div>
        	...
        	<div class="rightTitle"><span class="guide"><a href="<?php echo home_url(); ?>">Home</a> » <a href="<?php echo get_category_link($cats[0]->cat_ID); ?>">About Us</a> » Production Market </span><h1>Production Market</h1></div>
          <div class="rightMain">
                <div class="about-info2">
                   <!-- 内容开始 -->
                    <div class="rightTop">HENGDA high quality pulp and paper machine quick-wear parts adopt superior wear-resistant material and advanced processing technology, 
                      which makes HENGDA products durable and wear-resistant and also enjoys good reputation home and abroad. 
                      HENGDA has exported the whole set of pulp and paper manufacturing equipment and single machine like Drum pulper, Pressure screen to Egypt, Malaysia, Iran, Vietnam, Uzbekistan, South Africa, Zambia and other countries.</div>
                    <p><br><img alt="Hengda Clients" src="<?php echo get_theme_file_uri(); ?>/images/about2_05.jpg">
                    <img alt="Hengda Clients" src="<?php echo get_theme_file_uri(); ?>/images/about2_06.jpg">
                    <img alt="Hengda Clients" src="<?php echo get_theme_file_uri(); ?>/images/about2_07.jpg"></p>
                    <!-- 内容结束 -->
                    <div class="clear"></div>
                </div>
            </div>
