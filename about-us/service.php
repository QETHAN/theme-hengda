...
<div id="m-warp">
    ...
    <div class="clear"></div>
        	...
        	<div class="rightTitle"><span class="guide"><a href="<?php echo home_url(); ?>">Home</a> » <a href="<?php echo get_category_link($cats[0]->cat_ID); ?>">About Us</a> » Our Service </span><h1>Our Service</h1></div>
            <div class="rightMain">
