<?php
/*
 * Template Name: After-Sale Service模板
...
<div class="s-right" id="conRight">
    <div class="rightTitle">
        ...
        <?php echo esc_html( ucfirst(strtolower($category_name)) ); ?></a> » After-Sale Service</span>
        <h1>After-Sale Service</h1>
    </div>
    <div class="about-info">
                    <p class="aboutinfo">Hengda company professional engaged in the research, 
                    development and manufacture of the complete sets of waste paper pulp and paper production equipment for over decades of years. 
                    ...
                    <p>1. Highly inspecting equipments in every working procedure, quality comes first;<br>
                    2. Fast &amp; Safe Delivery; mulity-cylinder;<br>
                    3. Assisting our clients for foundation construction of equipments;<br>
                    4. Dispatching engineers to install and debug equipments;<br>
                    5. Training the first-line operators on site;<br>
                    6. Regularly visit clients to solve production problems;<br>
                    7. Providing life-long maintenance service;<br>
                    8. Providing technical exchanging.</p>
                    
                    <p>After-sale Service Tel.: <font style="font-size: 14px; color: #f00">+86-371-5512 9198</font><br>
                    After-sale Service Email: <font style="font-size: 14px; color: #f00">zzhengdachina@gmail.com</font></p> 
...
<form method="post" action="http://www.hengdapapermachine.com/mail/leizhan/" onsubmit="return chkInquiry()" name="msgForm" target="msgFrame">
        <input type="hidden" name="pWin" id="pWin" value="http://www.hengdapapermachine.com/contact-us/after-sale/">
